...
export class TransformAttValue extends AttValue {
  ...
  /**
   * @param {{x:import('../../types/types.js').ExactNum,y:import('../../types/types.js').ExactNum}} coords
   * @returns {{x:import('../../types/types.js').ExactNum,y:import('../../types/types.js').ExactNum}|undefined}
   */
  transformCoords(coords) {
    return this.#transform?.transformCoords(coords);
  }
}
