/**
 * @deprecated
 * @typedef {import('./types.js').XastElement&{style?:string,declarations?:import('./types.js').CSSDeclarationMap}} XastElementExtended
 */
 ...
 */
export function getStyleAttValue(element) {
