/**
 * @deprecated
 * @typedef {import('./types.js').XastElement&{style?:string,declarations?:Map<string,import('../lib/types.js').CSSPropertyValue>}} XastElementExtended
 */
...
/**
 * @param {import('./types.js').CSSPropertyValue} prop
 * @returns {string}
 * @deprecated - use prop.value.toString()
 */
export function cssPropToString(prop) {
 ...
 * @returns {Map<string,import('../lib/types.js').CSSPropertyValue>|undefined}
 * @deprecated
 */
export function getStyleDeclarations(element) {
  ...
  if (element.style !== style) {
    ...
    element.declarations = parseStyleDeclarations(element.style);
  }
