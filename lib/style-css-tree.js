...
const parseRule = (ruleNode, isInMediaQuery) => {
  ...
  function getSelectorsAndDeclarations() {
    /** @type {{selectorList?:{selector:CSSSelector,specificity:[number,number,number]}[],declarations?:Map<string,import('../lib/types.js').CSSPropertyValue>}} */
    const data = {};
      ...
      case 'Declaration':
        {
          ...
          declarations.set(name, {
            value: parseProperty(name, csstree.generate(cssNode.value)),
