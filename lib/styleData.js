...
export class StyleData {
  ...
  /**
   * @param {import('../lib/types.js').CSSRuleSet[]} ruleSets
   */
  #initData(ruleSets) {
  ...
  minifyStyles(cssoUsage) {
    /** @type {import('../lib/types.js').CSSRuleSet[]} */
    const ruleSets = [];
 ...
 */
export function getCSS(styleElement) {
  let css = '';
 ...
 * @param {import('../lib/types.js').XastElement} styleElement
 */
export function getRuleSets(styleElement) {
  /** @type {import('./types.js').CSSRuleSet[]} */
  const ruleSets = [];
