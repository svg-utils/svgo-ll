 ...
 * @returns {{x1:import('../types.js').ExactNum,y1:import('../types.js').ExactNum,x2:import('../types.js').ExactNum,y2:import('../types.js').ExactNum}|undefined}
 */
...
/**
 * @param {import('../types.js').ComputedPropertyMap} properties
 * @returns {{rx:string,ry:string}|undefined}
 */
export function getEllipseProperties(properties) {
  /** @type {import('../types.js').AttValue|string|null|undefined} */
 ...
 */
function getLenPctPixels(element, attName) {
