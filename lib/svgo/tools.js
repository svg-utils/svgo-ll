...
/**
 * @param {string} _propValue
 * @returns {{id:string,literalString:string}|undefined}
 * @deprecated
 */
export function getReferencedIdInStyleProperty(_propValue) {
  throw new Error();
}

/**
 * @param {import('../attrs/styleAttValue.js').StyleAttValue} _declMap
 * @param {Map<string,string>} _idMap
 * @deprecated
 */
export function updateReferencedDeclarationIds(_declMap, _idMap) {
  throw new Error();
}
