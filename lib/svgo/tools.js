...
import { svgAttTransformToCSS, svgToString } from '../svg-parse-att.js';
 ...
 * @returns {import('../types.js').CSSDeclarationMap}
 */
export function getInheritableProperties(element) {
  /** @type {import('../types.js').CSSDeclarationMap} */
  const props = new Map();
...
/**
 * @param {string|import('../types.js').SVGAttValue} v
